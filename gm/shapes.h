...
#define TRANSFORMATION_OF_HEXAHEDRON(x,local,M)                           \
	{ DOUBLE a,b,c,a0,a1,a2,a3;                                           \
	  ...
	  (M)[0][0] = a0*((x)[1][0]-x[0][0])+a1*((x)[2][0]-(x)[3][0])         \
	            + a2*((x)[5][0]-x[4][0])+a3*((x)[6][0]-(x)[7][0]);        \
	  (M)[0][1] = a0*((x)[1][1]-x[0][1])+a1*((x)[2][1]-(x)[3][1])         \
	            + a2*((x)[5][1]-x[4][1])+a3*((x)[6][1]-(x)[7][1]);        \
	  (M)[0][2] = a0*((x)[1][2]-x[0][2])+a1*((x)[2][2]-(x)[3][2])         \
	            + a2*((x)[5][2]-x[4][2])+a3*((x)[6][2]-(x)[7][2]);        \
      a0 = a * c;                                                         \
      a1 = (local)[0] * c;                                                \
      a2 = (local)[0] * (local)[2];                                       \
      a3 = a * (local)[2];                                                \
...
#define SIDE_NORMAL(n,i,x,normal)                                             \
  { DOUBLE s; DOUBLE_VECTOR a,b,axb; ELEMENT e;                               \
	V3_SUBTRACT(x[CORNER_OF_SIDE_REF((n),(i),2)],x[CORNER_OF_SIDE_REF((n),(i),0)],a); \
	V3_SUBTRACT(x[CORNER_OF_SIDE_REF((n),(i),1)],x[CORNER_OF_SIDE_REF((n),(i),0)],a); \
