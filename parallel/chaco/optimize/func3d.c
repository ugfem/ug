...
double func3d(coeffs, theta, phi, gamma)
double coeffs[15];              /* five different 4-way products */
double theta, phi, gamma;       /* angular parameters */
...
void grad3d(coeffs, grad, theta, phi, gamma)
double coeffs[15];              /* five different 4-way products */
...
double grad[3];                 /* gradient returned */
{
  ...
  for (i=0; i<3; i++) grad[i] = 2*cval*cgrad[i];
}
