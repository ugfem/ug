...
struct edgeslist {
  ...
  struct edgeslist *prev;        /* pointer to prev element in list */
};
...
struct connect_data {
  ...
  struct edgeslist *last_new_edges;             /* listend of new edges */
  struct ilists *last_old_edges;        /* last of overwritten old edges */
  struct flists *last_old_ewgts;        /* last of overwritten old weights */
};
